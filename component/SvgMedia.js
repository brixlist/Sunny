...
import { Cloud, CloudDrizzle, Snowflake, CloudFog } from "lucide-react-native";
  ...
  return (
    <>
      {props.code >= 200 && props.code <= 232 ? (
        ...
        <><Snowflake fill="#e5e5e5" size={380} stroke="#e5e5e5"></Snowflake></>
      ) : props.code >= 701 && props.code <= 781 ? (
        <><CloudFog fill="#adb5bd" size={380} stroke="#adb5bd"></CloudFog></>
